import { b as getApiURL, g as getFullApiUrl, a as apiEndpoints } from "./OM6BgpmZ.js";
import { g as getAdsenseConfig } from "./2f-ytn29.js";
import { _ as _export_sfc, p as useNuxtApp, g as ref, h as onMounted, c as createElementBlock, a as createBaseVNode, b as createVNode, w as withCtx, r as resolveComponent, o as openBlock, d as createTextVNode, t as toDisplayString, j as unref } from "./Bogji2Ua.js";
var define_process_env_default = {};
const _hoisted_1 = { class: "env-test" };
const _sfc_main = {
  __name: "env-test",
  setup(__props) {
    const { $configEnv } = useNuxtApp();
    const nodeEnv = ($configEnv == null ? void 0 : $configEnv.NODE_ENV) || "production";
    const apiUrl = ($configEnv == null ? void 0 : $configEnv.NUXT_PUBLIC_API_URL) || define_process_env_default.NUXT_PUBLIC_API_URL;
    const adsenseClientId = ($configEnv == null ? void 0 : $configEnv.NUXT_PUBLIC_ADSENSE_CLIENT_ID) || define_process_env_default.NUXT_PUBLIC_ADSENSE_CLIENT_ID;
    const adsenseTestMode = ($configEnv == null ? void 0 : $configEnv.NUXT_PUBLIC_ADSENSE_TEST_MODE) || define_process_env_default.NUXT_PUBLIC_ADSENSE_TEST_MODE;
    const { $config } = useNuxtApp();
    const runtimeConfig = ($config == null ? void 0 : $config.public) || "Not available";
    ...
    onMounted(() => {
      console.log("=== Vue.js Config.env Debug ===");
      console.log("Config.env loaded:", $configEnv);
...
const envTest = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-49329672"]]);
export {
  envTest as default
};
