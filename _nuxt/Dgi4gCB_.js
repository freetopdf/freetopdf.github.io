import { _ as __nuxt_component_0 } from "./7gsP0A7e.js";
import { _ as _export_sfc, g as ref, h as onMounted, c as createElementBlock, a as createBaseVNode, b as createVNode, w as withCtx, u as useRuntimeConfig, r as resolveComponent, i as useRouter, o as openBlock, d as createTextVNode, t as toDisplayString, f as createBlock, j as unref, F as Fragment, k as renderList } from "./CQi2DAuW.js";
import { g as getAdsenseConfig } from "./BByK324o.js";
import { u as useHead } from "./WfXFa4Cf.js";
...
const _hoisted_4 = { class: "usage-stat" };
const _hoisted_5 = { class: "usage-number" };
const _hoisted_6 = { class: "usage-stat" };
const _hoisted_7 = { class: "usage-number" };
const _hoisted_8 = { class: "usage-stat" };
const _hoisted_9 = { class: "usage-number" };
const _hoisted_10 = { class: "usage-message mt-3" };
const _hoisted_11 = {
  key: 1,
  class: "loading-usage"
};
const _hoisted_12 = { class: "features-section" };
const _hoisted_13 = { class: "adsense-section" };
const _hoisted_14 = { class: "tools-section" };
const _hoisted_15 = { class: "resources-section" };
const _hoisted_16 = { class: "faq-section" };
const _hoisted_17 = { class: "adsense-section" };
const _sfc_main = {
  __name: "index",
  setup(__props) {
        ...
        createBaseVNode("main", null, [
                          ...
                          default: withCtx(() => [
                            createVNode(_component_v_card_title, { class: "text-center text-h5 py-4" }, {
                              default: withCtx(() => [
                                ...
                                _cache[11] || (_cache[11] = createTextVNode(" Daily Usage Info "))
                              ]),
                              _: 1,
                              __: [11]
                            }),
                            createVNode(_component_v_card_text, { class: "text-center" }, {
                              default: withCtx(() => [
                                usageInfo.value ? (openBlock(), createElementBlock("div", _hoisted_3, [
                                  createVNode(_component_v_row, null, {
                                    default: withCtx(() => [
                                      createVNode(_component_v_col, { cols: "4" }, {
                                        default: withCtx(() => [
                                          createBaseVNode("div", _hoisted_4, [
                                            createBaseVNode("div", _hoisted_5, toDisplayString(usageInfo.value.used), 1),
                                            _cache[12] || (_cache[12] = createBaseVNode("div", { class: "usage-label" }, "Used", -1))
                                          ])
                                        ]),
                                        _: 1
                                      }),
                                      createVNode(_component_v_col, { cols: "4" }, {
                                        default: withCtx(() => [
                                          createBaseVNode("div", _hoisted_6, [
                                            createBaseVNode("div", _hoisted_7, toDisplayString(usageInfo.value.remaining), 1),
                                            _cache[13] || (_cache[13] = createBaseVNode("div", { class: "usage-label" }, "Remaining", -1))
                                          ])
                                        ]),
                                        _: 1
                                      }),
                                      createVNode(_component_v_col, { cols: "4" }, {
                                        default: withCtx(() => [
                                          createBaseVNode("div", _hoisted_8, [
                                            createBaseVNode("div", _hoisted_9, toDisplayString(usageInfo.value.limit), 1),
                                            _cache[14] || (_cache[14] = createBaseVNode("div", { class: "usage-label" }, "Daily Limit", -1))
                                          ])
                                        ]),
                                        _: 1
                                      })
                                  ...
                                  createBaseVNode("div", _hoisted_10, [
                                    usageInfo.value.remaining === 0 ? (openBlock(), createBlock(_component_v_alert, {
                                      ...
                                      default: withCtx(() => [
                                        _cache[16] || (_cache[16] = createTextVNode(" You've reached your daily free usage limit. Watch ads to continue using our tools. "))
                                      ]),
                                      _: 1,
                                      __: [16]
                                  ...
                                  _cache[19] || (_cache[19] = createBaseVNode("div", { class: "mt-2" }, "Loading usage information...", -1))
                                ]))
                              ]),
                              _: 1
                            })
          ...
          createBaseVNode("section", _hoisted_12, [
            createVNode(_component_v_container, { class: "py-12" }, {
              default: withCtx(() => [
                _cache[29] || (_cache[29] = createBaseVNode("h2", { class: "text-h4 text-center mb-8" }, "Why Choose FreeToPDF?", -1)),
                createVNode(_component_v_row, null, {
                  default: withCtx(() => [
                    createVNode(_component_v_col, {
                      cols: "12",
                      ...
                      default: withCtx(() => [
                        ...
                        _cache[21] || (_cache[21] = createBaseVNode("h3", { class: "text-h5 mb-3" }, "100% Secure", -1)),
                        _cache[22] || (_cache[22] = createBaseVNode("p", { class: "text-body-1" }, "Your files are processed locally in your browser. We never store or access your documents.", -1))
                      ]),
                      _: 1,
                      __: [21, 22]
                    }),
                    createVNode(_component_v_col, {
                      ...
                      default: withCtx(() => [
                        ...
                        _cache[24] || (_cache[24] = createBaseVNode("h3", { class: "text-h5 mb-3" }, "Completely Free", -1)),
                        _cache[25] || (_cache[25] = createBaseVNode("p", { class: "text-body-1" }, "No hidden costs, no premium features. All tools are free to use without any limitations.", -1))
                      ]),
                      _: 1,
                      __: [24, 25]
                    }),
                    createVNode(_component_v_col, {
                      ...
                      default: withCtx(() => [
                        ...
                        _cache[27] || (_cache[27] = createBaseVNode("h3", { class: "text-h5 mb-3" }, "No Registration", -1)),
                        _cache[28] || (_cache[28] = createBaseVNode("p", { class: "text-body-1" }, "Start using our tools immediately. No account creation or email verification required.", -1))
                      ]),
                      _: 1,
                      __: [27, 28]
                    })
          ...
          createBaseVNode("section", _hoisted_13, [
            createVNode(_component_v_container, { class: "py-6" }, {
              default: withCtx(() => [
          ...
          createBaseVNode("section", _hoisted_17, [
            createVNode(_component_v_container, { class: "py-6" }, {
              default: withCtx(() => [
                createVNode(_component_GoogleAdsense, {
                  "ad-slot": unref(adsenseConfig).slots.footer,
                  "ad-format": "auto",
                  "full-width-responsive": "true"
                }, null, 8, ["ad-slot"])
              ]),
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2af4c742"]]);
export {
  index as default
};
