...
import { _ as _export_sfc, g as ref, l as computed, h as onMounted, r as resolveComponent, c as createElementBlock, m as createCommentVNode, o as openBlock, a as createBaseVNode, b as createVNode, j as unref, t as toDisplayString, w as withCtx, d as createTextVNode, f as createBlock, i as useRouter, n as withModifiers, v as normalizeClass } from "./Bogji2Ua.js";
...
const _hoisted_2$1 = { class: "interstitial-modal" };
const _hoisted_3$1 = { class: "ad-container" };
const _hoisted_4$1 = {
  key: 0,
  class: "test-ad-content"
};
const _hoisted_5$1 = { class: "test-ad-banner" };
const _hoisted_6$1 = { class: "test-ad-info" };
...
const _sfc_main$1 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const interstitialAdSlot = computed(
      () => adsenseConfig.slots.interstitial || "interstitial_default"
    );
    ...
    const handleAdComplete = async () => {
      loading.value = true;
      try {
        const response = await fetch("/api/mark-ad-watched", {
          method: "POST",
          headers: {
    ...
    return (_ctx, _cache) => {
      ...
      return __props.show ? (openBlock(), createElementBlock("div", _hoisted_1$1, [
        createBaseVNode("div", _hoisted_2$1, [
          _cache[5] || (_cache[5] = createBaseVNode("div", { class: "modal-header" }, [
          ...
          createBaseVNode("div", _hoisted_3$1, [
            createVNode(_component_GoogleAdsense, {
              "ad-slot": unref(interstitialAdSlot),
              "ad-format": "interstitial"
            }, null, 8, ["ad-slot"]),
            unref(isTestMode) ? (openBlock(), createElementBlock("div", _hoisted_4$1, [
              createBaseVNode("div", _hoisted_5$1, [
                _cache[1] || (_cache[1] = createBaseVNode("h3", null, "🎯 Test Interstitial Ad", -1)),
                _cache[2] || (_cache[2] = createBaseVNode("p", null, "This is a test ad. In production, real Google AdSense ads will appear here.", -1)),
                createBaseVNode("div", _hoisted_6$1, [
                  createBaseVNode("span", null, "Slot: " + toDisplayString(unref(interstitialAdSlot)), 1),
                  _cache[0] || (_cache[0] = createBaseVNode("span", null, "Format: Interstitial", -1))
                ])
              ])
...
const InterstitialAd = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-e3483c09"]]);
