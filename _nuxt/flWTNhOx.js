...
import { _ as _export_sfc, g as ref, f as createBlock, w as withCtx, r as resolveComponent, i as useRouter, o as openBlock, b as createVNode, m as createCommentVNode, a as createBaseVNode, j as unref, t as toDisplayString, d as createTextVNode, n as withModifiers, v as normalizeClass } from "./Bogji2Ua.js";
import { F as FullscreenLoading } from "./ByTkx2O2.js";
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createBlock(_component_v_container, { class: "py-12" }, {
        default: withCtx(() => [
                              ...
                              createVNode(_component_v_card, { class: "ad-inline text-center pa-4" }, {
                                default: withCtx(() => [
                                  createBaseVNode("div", _hoisted_5, [
                                    ...
                                    _cache[20] || (_cache[20] = createBaseVNode("p", { class: "text-body-2 text-grey-lighten-1 mt-2" }, "Advertisement Space", -1)),
                                    _cache[21] || (_cache[21] = createBaseVNode("p", { class: "text-caption text-grey-lighten-1" }, "300x250 Inline Ad", -1))
                                  ])
                                ]),
                                _: 1
                              })
          ...
          createVNode(_component_v_row, { class: "mt-12 mb-8" }, {
            default: withCtx(() => [
              createVNode(_component_v_col, { cols: "12" }, {
                default: withCtx(() => [
                  createVNode(_component_v_card, { class: "ad-banner text-center pa-4" }, {
                    default: withCtx(() => [
                      createBaseVNode("div", _hoisted_7, [
                        ...
                        _cache[26] || (_cache[26] = createBaseVNode("p", { class: "text-caption text-grey-lighten-1" }, "728x90 Banner Ad", -1))
                      ])
                    ]),
                    _: 1
                  })
          ...
          createVNode(_component_v_row, { class: "mt-12" }, {
            default: withCtx(() => [
              createVNode(_component_v_col, { cols: "12" }, {
                default: withCtx(() => [
                  _cache[45] || (_cache[45] = createBaseVNode("h2", { class: "text-h4 text-center mb-6" }, "Why Convert PDF to Word?", -1)),
                          ...
                          createVNode(_component_v_card, {
                            ...
                            default: withCtx(() => [
                              createBaseVNode("h3", _hoisted_8, [
                                ...
                                _cache[28] || (_cache[28] = createTextVNode(" Edit and Modify Content "))
                              ]),
                              _cache[35] || (_cache[35] = createBaseVNode("p", { class: "text-body-1 mb-3" }, " Convert PDFs to Word to easily edit text, modify layouts, add new content, or update existing information. Perfect for documents that need regular updates. ", -1)),
                          ...
                          createVNode(_component_v_card, {
                            ...
                            default: withCtx(() => [
                              createBaseVNode("h3", _hoisted_9, [
                                ...
                                _cache[37] || (_cache[37] = createTextVNode(" Collaboration and Sharing "))
                              ]),
                              _cache[44] || (_cache[44] = createBaseVNode("p", { class: "text-body-1 mb-3" }, " Word documents are perfect for collaborative work, allowing multiple people to edit, comment, and track changes in real-time. ", -1)),
                              createVNode(_component_v_list, { density: "compact" }, {
                                default: withCtx(() => [
                                  createVNode(_component_v_list_item, null, {
                                    prepend: withCtx(() => [
                  ...
                  createVNode(_component_v_card, {
                    ...
                    default: withCtx(() => [
                      createBaseVNode("h3", _hoisted_10, [
                        ...
                        _cache[47] || (_cache[47] = createTextVNode(" Pro Tips for Best Results "))
                      ]),
                      createVNode(_component_v_row, null, {
                        default: withCtx(() => [
                          createVNode(_component_v_col, {
          ...
          createVNode(_component_v_row, { class: "mt-8" }, {
            default: withCtx(() => [
              createVNode(_component_v_col, { cols: "12" }, {
                default: withCtx(() => [
                  _cache[53] || (_cache[53] = createBaseVNode("h3", { class: "text-h5 text-center mb-4" }, "Related PDF Tools", -1)),
                  createVNode(_component_v_row, { justify: "center" }, {
                    default: withCtx(() => [
                      createVNode(_component_v_col, {
                        cols: "12",
...
const pdfToWord = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-935daa57"]]);
export {
