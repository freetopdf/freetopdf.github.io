import { _ as __nuxt_component_0 } from "./BQ503A-c.js";
import { r as resolveComponent, T as TransitionGroup, D as defineComponent, C as nextTick, E as h, _ as _export_sfc, g as ref, f as createBlock, w as withCtx, i as useRouter, o as openBlock, b as createVNode, l as createCommentVNode, a as createBaseVNode, p as unref, t as toDisplayString, d as createTextVNode, m as withModifiers, n as normalizeClass, A as isRef, q as trackApiCallStart, s as trackFileConversion, v as trackUsageLimit, y as trackApiCallError, z as trackApiCallSuccess } from "./CZig_RTy.js";
import { F as FullscreenLoading } from "./DdUQfl6K.js";
import { g as getFullApiUrl, a as apiEndpoints } from "./CZ13b-GK.js";
import { g as getAdsenseConfig } from "./OCWGi-R8.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    useHead({
      title: "Convert to PDF - Free Online File Converter | FreeToPDF",
      meta: [
        {
          name: "description",
          content: "Convert images, Word documents, and other files to PDF online for free. Support for JPG, PNG, DOCX, TXT, PPTX, XLSX formats. No registration required."
        },
        {
          name: "keywords",
          content: "convert to PDF, PDF converter, image to PDF, Word to PDF, document converter, online PDF converter, free PDF converter"
        },
        {
          name: "robots",
      ...
      script: [
        {
          ...
          children: JSON.stringify({
            ...
            "@type": "WebApplication",
            "name": "Convert to PDF",
            "description": "Free online tool to convert various file formats to PDF",
            "url": "https://freetopdf.com/convert-to-pdf",
    ...
    const validateFile = (file) => {
      ...
      if (!Object.keys(ALLOWED_TYPES).includes(fileType)) {
        error.value = `${file.name} is not a supported file format.`;
        return false;
      }
      return true;
    };
    ...
    const convertToPDF = async () => {
      ...
      try {
        ...
        console.log("Sending files:", selectedFiles.value);
        trackApiCallStart("word_to_pdf", "POST");
        selectedFiles.value.forEach((file) => {
          trackFileConversion("word_to_pdf", file.type, file.size);
        });
        const convertUrl = await getFullApiUrl(apiEndpoints.wordToPdf);
        ...
        if (!response.ok) {
          if (response.status === 429 && data.error === "무료 사용 한도 초과") {
            ...
            error.value = `You have used all your free usage limit (${data.limit} times). Watch ads to continue using our tools.`;
            if (data.current_count !== void 0 && data.limit !== void 0) {
              error.value += ` (Current: ${data.current_count}/${data.limit})`;
            }
          } else {
        ...
        if (!data.pdf_path) {
          throw new Error("Failed to receive PDF path.");
        }
        router.push({
          path: "/download-pdf",
          query: { path: data.pdf_path }
        });
      } catch (err) {
        console.error("Error during conversion:", err);
        error.value = err.message || "An error occurred during PDF conversion.";
        loading.value = false;
        nextTick(() => {
        ...
        default: withCtx(() => [
                ...
                default: withCtx(() => [
                  createVNode(_component_v_card, { class: "pa-6" }, {
                    default: withCtx(() => [
                        ...
                        default: withCtx(() => [
                          createBaseVNode("div", _hoisted_1, [
                            createBaseVNode("div", _hoisted_2, [
                              _cache[7] || (_cache[7] = createBaseVNode("div", { class: "text-subtitle-1 font-weight-bold mb-1" }, "Error", -1)),
                        ...
                        default: withCtx(() => [
                          createVNode(_component_v_card_text, { class: "text-center py-12" }, {
                            default: withCtx(() => [
                              ...
                              _cache[11] || (_cache[11] = createBaseVNode("div", { class: "text-h6 mb-2" }, " Drag and drop your files here ", -1)),
                              _cache[12] || (_cache[12] = createBaseVNode("div", { class: "text-body-1 text-medium-emphasis mb-4" }, " or ", -1)),
                              _cache[13] || (_cache[13] = createBaseVNode("div", { class: "text-body-2 text-medium-emphasis" }, " Supported formats: JPG, PNG, GIF, WEBP, PDF, DOC, DOCX, TXT, PPT, PPTX, XLS, XLSX ", -1)),
                              _cache[14] || (_cache[14] = createBaseVNode("div", { class: "text-body-2 text-medium-emphasis mt-2" }, " Maximum file size: 5MB ", -1)),
                      ...
                      unref(selectedFiles).length > 0 ? (openBlock(), createBlock(_component_v_card, {
                        key: 1,
                        class: "mb-6"
                      }, {
                        default: withCtx(() => [
                          createVNode(_component_v_card_text, null, {
                            default: withCtx(() => [
                              createVNode(unref(draggableComponent), {
                                ...
                                "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => isRef(selectedFiles) ? selectedFiles.value = $event : null),
                                "item-key": "name",
                                handle: ".drag-handle",
                                class: "file-list",
                                "ghost-class": "ghost"
                              }, {
                                item: withCtx(({ element: file, index: index2 }) => [
                                      ...
                                      createBaseVNode("div", _hoisted_5, [
                                        createVNode(_component_v_icon, {
                                          ...
                                          default: withCtx(() => _cache[15] || (_cache[15] = [
                                            createTextVNode(" mdi-arrow-up-down ")
                                          ])),
                                          _: 1,
                                          __: [15]
                                        }),
                      ...
                      createBaseVNode("div", _hoisted_6, [
                        createVNode(_component_v_btn, {
                          color: "primary",
                          size: "x-large",
                          disabled: unref(selectedFiles).length === 0 || unref(loading),
                          ...
                          createVNode(_component_v_col, { cols: "12" }, {
                            default: withCtx(() => [
                              createVNode(_component_GoogleAdsense, {
                                "ad-slot": unref(adsenseConfig).slots.main,
                                "ad-format": "auto",
          ...
          createVNode(_component_v_row, { class: "mt-12" }, {
            default: withCtx(() => [
              createVNode(_component_v_col, { cols: "12" }, {
                default: withCtx(() => [
                  _cache[38] || (_cache[38] = createBaseVNode("h2", { class: "text-h4 text-center mb-6" }, "Why Convert Files to PDF?", -1)),
                        ...
                        default: withCtx(() => [
                          createVNode(_component_v_card, {
                            ...
                            default: withCtx(() => [
                              ...
                              _cache[28] || (_cache[28] = createBaseVNode("p", { class: "text-body-1 mb-3" }, " PDF format ensures your documents look the same across all devices and platforms. Convert various file types to PDF for consistent viewing and sharing. ", -1)),
                          ...
                          createVNode(_component_v_card, {
                            ...
                            default: withCtx(() => [
                              createBaseVNode("h3", _hoisted_8, [
                                ...
                                _cache[30] || (_cache[30] = createTextVNode(" Professional Presentation "))
                              ]),
                              _cache[37] || (_cache[37] = createBaseVNode("p", { class: "text-body-1 mb-3" }, " Create professional documents by converting images, Word docs, and other files to PDF. Perfect for business reports, presentations, and official documents. ", -1)),
                              createVNode(_component_v_list, { density: "compact" }, {
                                default: withCtx(() => [
                                  createVNode(_component_v_list_item, null, {
                                    prepend: withCtx(() => [
                                    ...
                                    default: withCtx(() => [
                                      createVNode(_component_v_list_item_title, null, {
                                        default: withCtx(() => _cache[36] || (_cache[36] = [
                                          createTextVNode("Easy to share and archive")
                                        ])),
                                        _: 1,
                                        __: [36]
                                      })
                        ...
                        default: withCtx(() => [
                          createVNode(_component_v_col, {
                            ...
                            default: withCtx(() => _cache[41] || (_cache[41] = [
                              createBaseVNode("ul", { class: "text-body-1" }, [
                                createBaseVNode("li", { class: "mb-2" }, "Use high-quality source files for better PDF output"),
                                createBaseVNode("li", { class: "mb-2" }, "Arrange files in desired order before conversion"),
                                createBaseVNode("li", { class: "mb-2" }, "Check file sizes to stay within 5MB limit")
                              ], -1)
                            ])),
                            _: 1,
                            __: [41]
                          ...
                          createVNode(_component_v_col, {
                            ...
                            default: withCtx(() => _cache[42] || (_cache[42] = [
                              createBaseVNode("ul", { class: "text-body-1" }, [
                                createBaseVNode("li", { class: "mb-2" }, "Text-based documents convert best to PDF"),
                                createBaseVNode("li", { class: "mb-2" }, "Images will be embedded as pages in PDF"),
                                createBaseVNode("li", { class: "mb-2" }, "Multiple files will be combined into one PDF")
                              ], -1)
                            ])),
                            _: 1,
                            __: [42]
                      ...
                      createVNode(_component_v_col, {
                        ...
                        default: withCtx(() => [
                          createVNode(_component_v_btn, {
                            ...
                            variant: "outlined",
                            block: "",
                            onClick: _cache[4] || (_cache[4] = ($event) => _ctx.$router.push("/pdf-to-word")),
...
const convertToPdf = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-300ad038"]]);
export {
