...
import { _ as _export_sfc, h as ref, k as computed, f as createBlock, w as withCtx, r as resolveComponent, u as useRouter, o as openBlock, b as createVNode, l as createCommentVNode, a as createBaseVNode, d as createTextVNode, m as withModifiers, n as normalizeClass, t as toDisplayString, c as createElementBlock, F as Fragment, j as renderList, p as unref, q as nextTick, s as trackApiCallStart, v as trackFileConversion, x as trackUsageLimit, y as trackAdView, z as trackApiCallError, A as trackApiCallSuccess } from "./BfEuadgy.js";
...
const _hoisted_9 = { class: "text-subtitle-1 mb-3" };
const _hoisted_10 = { class: "text-subtitle-1 mb-3" };
const _hoisted_11 = { class: "text-subtitle-1 mb-3" };
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const handleAdCompleted = async (data) => {
      ...
      console.log("🔄 Pending conversion:", pendingConversion.value);
      if (pendingConversion.value) {
        console.log("🚀 Starting merge after ad completion");
        pendingConversion.value = false;
        showInterstitialAd.value = false;
        isConverting.value = true;
        await nextTick();
        await new Promise((resolve) => requestAnimationFrame(resolve));
        console.log("🔄 Calling mergeFiles after DOM update");
        await mergeFiles();
      } else {
        showInterstitialAd.value = false;
      }
        ...
        default: withCtx(() => [
              ...
              createVNode(_component_v_col, {
                ...
                default: withCtx(() => [
                  createVNode(_component_v_card, { class: "pa-6" }, {
                    default: withCtx(() => [
                      createVNode(_component_v_card_title, { class: "text-h5 text-center mb-4" }, {
                        default: withCtx(() => [
                      ...
                      createVNode(_component_v_card, {
                        class: normalizeClass(["upload-area mb-4", { "upload-area--active": isDragging.value }]),
                        ...
                        default: withCtx(() => [
                          createVNode(_component_v_card_text, { class: "text-center py-6 py-md-8" }, {
                            default: withCtx(() => [
                              ...
                              _cache[11] || (_cache[11] = createBaseVNode("div", { class: "text-subtitle-1 mb-2" }, " Drag and drop PDF files here ", -1)),
                              _cache[12] || (_cache[12] = createBaseVNode("div", { class: "text-body-2 text-medium-emphasis mb-3" }, " or ", -1)),
                              _cache[13] || (_cache[13] = createBaseVNode("div", { class: "text-caption text-medium-emphasis mb-3" }, " Maximum file size: 5MB per file ", -1)),
                              _cache[14] || (_cache[14] = createBaseVNode("div", { class: "text-caption text-medium-emphasis mb-3" }, " Total file size limit: 5MB ", -1)),
                              _cache[15] || (_cache[15] = createBaseVNode("div", { class: "text-caption text-medium-emphasis mb-3" }, " Minimum: 2 PDF files required for merging ", -1)),
                      ...
                      isConverting.value ? (openBlock(), createBlock(FullscreenLoading, { key: 1 })) : createCommentVNode("", true),
          ...
          createVNode(_component_v_row, { class: "mt-6 mt-md-8" }, {
            default: withCtx(() => [
              createVNode(_component_v_col, { cols: "12" }, {
                default: withCtx(() => [
                  _cache[38] || (_cache[38] = createBaseVNode("h2", { class: "text-h5 text-center mb-4" }, "Why Merge PDF Files?", -1)),
                        ...
                        default: withCtx(() => [
                          createVNode(_component_v_card, {
                            ...
                            default: withCtx(() => [
                              ...
                              _cache[28] || (_cache[28] = createBaseVNode("p", { class: "text-body-2 mb-3" }, " Combine multiple PDF files into a single document for better organization and easier management. Perfect for reports, presentations, and document collections. ", -1)),
                        ...
                        default: withCtx(() => [
                          createVNode(_component_v_card, {
                            ...
                            default: withCtx(() => [
                              ...
                              _cache[37] || (_cache[37] = createBaseVNode("p", { class: "text-body-2 mb-3" }, " Share multiple documents as one file instead of sending separate attachments. Reduce email clutter and make document sharing more professional. ", -1)),
                              createVNode(_component_v_list, { density: "compact" }, {
                                default: withCtx(() => [
                                  createVNode(_component_v_list_item, null, {
                                    prepend: withCtx(() => [
                        ...
                        default: withCtx(() => [
                          createVNode(_component_v_col, {
                            ...
                            default: withCtx(() => _cache[41] || (_cache[41] = [
                              createBaseVNode("ul", { class: "text-body-2" }, [
                                createBaseVNode("li", { class: "mb-1" }, "Arrange files in the desired order before merging"),
                                createBaseVNode("li", { class: "mb-1" }, "Ensure all PDFs are readable and not corrupted"),
                                createBaseVNode("li", { class: "mb-1" }, "Keep total file size under 5MB for best performance")
                              ], -1)
                            ])),
                            _: 1,
                            __: [41]
                          ...
                          createVNode(_component_v_col, {
                            ...
                            default: withCtx(() => _cache[42] || (_cache[42] = [
                              createBaseVNode("ul", { class: "text-body-2" }, [
                                createBaseVNode("li", { class: "mb-1" }, "Use descriptive names for merged files"),
                                createBaseVNode("li", { class: "mb-1" }, "Check merged result before sharing"),
                                createBaseVNode("li", { class: "mb-1" }, "Consider file order for logical document flow")
                              ], -1)
                            ])),
                            _: 1,
                            __: [42]
...
const merge = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f285d5f2"]]);
export {
  merge as default
};
