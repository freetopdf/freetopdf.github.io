...
import { _ as _export_sfc, g as ref, f as createBlock, w as withCtx, r as resolveComponent, i as useRouter, o as openBlock, b as createVNode, p as unref, l as createCommentVNode, a as createBaseVNode, t as toDisplayString, d as createTextVNode, m as withModifiers, n as normalizeClass } from "./ChlgQOOl.js";
import { F as FullscreenLoading } from "./OtbW-6ls.js";
import { I as InterstitialAd } from "./BlcV5y-T.js";
        ...
        default: withCtx(() => [
                    ...
                    default: withCtx(() => [
                      ...
                      createVNode(_component_v_alert, {
                        ...
                        default: withCtx(() => _cache[10] || (_cache[10] = [
                          ...
                          createBaseVNode("div", { class: "text-caption" }, " • PDF files (.pdf) • Output: Microsoft Word (.docx) ", -1)
                        ])),
                        _: 1,
                        __: [10]
                      }),
                        ...
                        default: withCtx(() => [
                          createVNode(_component_v_card_text, { class: "text-center py-6 py-md-8" }, {
                            default: withCtx(() => [
                              ...
                              _cache[13] || (_cache[13] = createBaseVNode("div", { class: "text-subtitle-1 mb-2" }, " Drag and drop your PDF file here ", -1)),
          ...
          createVNode(_component_v_row, { class: "mt-6 mt-md-8" }, {
            default: withCtx(() => [
              createVNode(_component_v_col, { cols: "12" }, {
                default: withCtx(() => [
                  _cache[39] || (_cache[39] = createBaseVNode("h2", { class: "text-h5 text-center mb-4" }, "Why Convert PDF to Word?", -1)),
                        ...
                        default: withCtx(() => [
                          createVNode(_component_v_card, {
                            ...
                            default: withCtx(() => [
                              ...
                              _cache[29] || (_cache[29] = createBaseVNode("p", { class: "text-body-2 mb-3" }, " Convert PDFs to Word to easily edit text, modify layouts, add new content, or update existing information. Perfect for documents that need regular updates. ", -1)),
                        ...
                        default: withCtx(() => [
                          createVNode(_component_v_card, {
                            ...
                            default: withCtx(() => [
                              ...
                              _cache[38] || (_cache[38] = createBaseVNode("p", { class: "text-body-2 mb-3" }, " Word documents are perfect for collaborative work, allowing multiple people to edit, comment, and track changes in real-time. ", -1)),
                              createVNode(_component_v_list, { density: "compact" }, {
                                default: withCtx(() => [
                                  createVNode(_component_v_list_item, null, {
                                    prepend: withCtx(() => [
                        ...
                        default: withCtx(() => [
                          createVNode(_component_v_col, {
                            ...
                            default: withCtx(() => _cache[42] || (_cache[42] = [
                              createBaseVNode("ul", { class: "text-body-2" }, [
                                createBaseVNode("li", { class: "mb-1" }, "Ensure your PDF has clear, readable text for optimal conversion"),
                                createBaseVNode("li", { class: "mb-1" }, "Scanned documents may require OCR for better results"),
                                createBaseVNode("li", { class: "mb-1" }, "Complex layouts with tables and images convert best")
                              ], -1)
                            ])),
                            _: 1,
                            __: [42]
                          ...
                          createVNode(_component_v_col, {
                            ...
                            default: withCtx(() => _cache[43] || (_cache[43] = [
                              createBaseVNode("ul", { class: "text-body-2" }, [
                                createBaseVNode("li", { class: "mb-1" }, "Avoid PDFs with heavy graphics for faster processing"),
                                createBaseVNode("li", { class: "mb-1" }, "Check the converted file for any formatting issues"),
                                createBaseVNode("li", { class: "mb-1" }, "Use high-quality source PDFs for best results")
                              ], -1)
                            ])),
                            _: 1,
                            __: [43]
          ...
          createVNode(_component_v_row, { class: "mt-4 mt-md-6" }, {
            default: withCtx(() => [
              createVNode(_component_v_col, { cols: "12" }, {
                default: withCtx(() => [
                  _cache[47] || (_cache[47] = createBaseVNode("h3", { class: "text-subtitle-1 text-center mb-3" }, "Related PDF Tools", -1)),
                  createVNode(_component_v_row, { justify: "center" }, {
                    default: withCtx(() => [
                      createVNode(_component_v_col, {
                        cols: "12",
...
const pdfToWord = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ac4e11a4"]]);
export {
