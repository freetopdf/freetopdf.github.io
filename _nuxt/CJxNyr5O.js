  ...
  setup(__props) {
    ...
    const fetchUsageInfo = async () => {
      try {
        ...
        const apiUrl = config.public.apiUrl || "http://localhost:8100";
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-14003a7d"]]);
export {
  index as default
};
